			...
			<div class="col-lg-5">
				<div class="product_details">
					...
					<form method="post">
						...
						<span>Quantity:</span>
							<input type="number" min="1" name="jumlah" class="form-control" value="1"  max="<?php echo $detail['stok'] ?>">
						...
						<div class="row">
							...
							<div class="col-lg-6 add_review_col">
								...
								<div class="add_review">
									<form action="komen.php?id=<?php echo $detail['id_produk'] ?>" method="post">
										<div>
											<h1>Add Review</h1>
											<input id="review_name" class="form_input input_name" type="text" name="nama" placeholder="Name*" required="required" data-error="Name is required." value="<?php echo $pecah['username']?>" readonly>
											<input id="review_email" class="form_input input_email" type="email" name="email" placeholder="Email*" required="required" data-error="Valid email is required." value="<?php echo $pecah['email']?>" readonly>
										</div>
										<div>
											<textarea id="review_message" class="input_review mb-3" name="komentar"  placeholder="Your Review" rows="4" required data-error="Please, leave us a review."></textarea>
										</div>
